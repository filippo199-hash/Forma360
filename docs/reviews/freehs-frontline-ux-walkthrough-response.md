...
| UXW2-02 | S4 | The `/scan` frame now speaks the worker's word: heading composes "Report: Hazard" (the category name IS the noun), thanks copy drops "observation" — "Thanks — that's logged." / "Report another". All 10 locales. | bundles (`scanPage.*`), composition at `scan-report-form.tsx` |

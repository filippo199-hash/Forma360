...
export function OfflineQueueFlusher() {
  ...
  return (
    <div
      role="status"
      className="fixed bottom-20 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full border border-amber-300 bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-900 shadow-md md:bottom-4 dark:border-amber-700 dark:bg-amber-950 dark:text-amber-100"
    >

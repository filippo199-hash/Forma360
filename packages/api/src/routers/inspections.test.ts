...
/**
 * UXW4-02 — the title tokens, tested directly.
 *
 ...
 * The pure function is pinned here rather than through a router call so
 * the format cannot drift back without a red test.
 */
